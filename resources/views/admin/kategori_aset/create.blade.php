@extends('layouts.app')
@section('title', 'Tambah Kategori Aset - SIM Sarpras')
@section('page_title', 'Tambah Kategori Aset')
@section('content')
<div class="card card-stat bg-white mb-4">
    <div class="card-body">
        <h5 class="card-title fw-bold text-success mb-4">Form Tambah Kategori Aset</h5>
        <form action="{{ route('admin.kategori_aset.store') }}" method="POST">
            @csrf
            <div class="mb-3">
